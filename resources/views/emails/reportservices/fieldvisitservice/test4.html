...
<div id="container">
	<div id="header">
		...
		<div id="reference">
			<h3><strong>FIELD VISIT REPORT</strong></h3>
			<h4>Ref. : {{ $data['report_id'] }}</h4>
			<p>Date  : {{ $data['submit_date'] }} </p>
		</div>
	</div>
	<br><br>
	<div id="fromto">
        <div id="from">
			<p>
				...
				{{ $data['submit_to'] }} <br><br>
                <strong>Submit Date</strong><br>
				{{ $data['submit_date'] }} <br><br>
		...
		<div id="to">
			<p>
                System: ECS <br>
				Visiting Date: {{ $data['visiting_date'] }} <br>
                Visiting Time: {{ $data['visiting_time'] }} <br>
	...
	<div id="items">
		...
		<table>
			<tr>
				<td>Details, Observations &amp; Findings</td>
				<td>{{ $data['details_findings'] }}</td>
			</tr>
			<tr>
				<td>Summary</td>
				<td>{{ $data['summary'] }}</td>
	...
	<div id="summary">
		...
		<div id="total">
			<table border="1">
				<tr>
					<td>Report By</td>
					<td>{{ $data['report_by_name_1'] }}</td>
				</tr>
                <tr>
					<td>Signature</td>
                    <td>{{ $data['report_by_name_1_date'] }}</td>
				</tr>
                <tr>
                    <td colspan="2">
                        <img src="{{ $data['report_by_name_1_signature'] }}" alt="" width="100px" height=" 80px">
                    </td>
                </tr>
			</table>
	...
	@if ($data['report_by_name_2'] !== null)
    <div id="summary">
		<div id="total">
			<table border="1">
				<tr>
					<td>Report By</td>
					<td>{{ $data['report_by_name_2'] }}</td>
				</tr>
				<tr>
                    <td>Signature</td>
                    <td>{{ $data['report_by_name_2_date'] }}</td>
				</tr>
                <tr>
                    <td colspan="2">
                        <img src="https://www.best-signature.com/wp-content/uploads/2016/02/e13_1.jpg" alt="" width="100px" height=" 80px">
                    </td>
                </tr>
			</table>
	...
	@endif
	@if ($data['report_by_name_3'] !== null)
    <div id="summary">
		<div id="total">
			<table border="1">
				<tr>
					<td>Report By</td>
					<td>{{ $data['report_by_name_3'] }}</td>
				</tr>
				<tr>
                    <td>Signature</td>
